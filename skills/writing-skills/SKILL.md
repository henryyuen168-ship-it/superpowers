...
**Personal skills live in agent-specific or platform-installed skill directories. In OpenClaw, adapt examples to the local installed skill surface rather than assuming Claude-specific paths.**
